...
namespace InventoryProject.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class InventoryProjectModule : ModuleBase {
        static InventoryProjectModule() {
            ...
            // #if DEBUG
            // Database.SetInitializer(new DropCreateDatabaseIfModelChanges<InventoryProjectDbContext>());
            // #endif 
        }
        public InventoryProjectModule() {
            InitializeComponent();
